...
export function SeekerFeed({ interceptor, target, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-t px-2 py-1 font-mono text-[10px] text-neutral-400" style={{ borderColor: `${accent}33` }}>
